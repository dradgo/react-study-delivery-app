    ...
    return (
        <div className="dish-card">
            ...
            <div className="dish-info">
                ...
                <p>Цена: {dish.price}</p>
                <p>
                    Состав: {dish.nutrition.fat}, Сахар: {dish.nutrition.sugar}, Белок:{' '}
                    {dish.nutrition.protein}, Калории: {dish.nutrition.calories}
                </p>
                <p>Есть в наличии: {dish.available ? 'Yes' : 'No'}</p>
                {cartItem ? (
                    <div className="cart-controls">
                        <button onClick={() => handleChangeAmount({ dishId: dish.id, amount: -1 })}>
                            -
                        </button>
                        ...
                        <button
                            onClick={() => handleRemoveFromCart({ dishId: dish.id })}
