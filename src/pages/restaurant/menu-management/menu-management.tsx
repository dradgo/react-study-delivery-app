          ...
          {menuItems.map(item => (
            <div key={item.id} className="menu-management__item">
              ...
              <p className="menu-management__item-nutrition">
                Состав: {item.nutrition.fat}, Сахар: {item.nutrition.sugar},
                Белок: {item.nutrition.protein}, Калории: {item.nutrition.calories}
              </p>
              <p className="menu-management__item-nutrition">
              ...
              <div className="menu-management__item-actions">
                <button
                  ...
                  onClick={() => editMenuItem(item.id, { available: !item.available })}
                >
